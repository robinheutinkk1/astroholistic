...
> **Status: Fase 7 afgerond** — NFC en QR werken: tags aanmaken, koppelen,
> scannen en inchecken. `npm run verify` groen (158 tests),
> `npm run test:security` groen (187 tests).
> Realtime dispatch volgt in Fase 8.
